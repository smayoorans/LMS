 ...
 * View to edit
 */
class KindLMSViewConfiguration extends JView
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$canDo		= KindLMSHelper::getActions();

		JToolBarHelper::title(JText::_('COM_KINDLMS_TITLE_CONFIGURATION'), 'configuration.png');
